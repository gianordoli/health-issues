...
export class LoadingAnimation {
  ...
  constructor(container: HTMLElement) {
    ...
    this.shape = container.querySelector('svg.morph path.outline');
    this.animate(this, 0);
  }

  animate(self: LoadingAnimation, i) {
    const { shape, animate, paths } = self;
    anime({
      targets: shape,
      duration: 1000,
